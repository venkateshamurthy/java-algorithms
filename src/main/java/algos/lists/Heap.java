...
public interface Heap<E extends Comparable<E>> extends Queue<E>{
   ...
   * @param location at which the heapify down occurs
   */
   ...
   * Heapify Down operation 
   * @param location at which the heapify down occurs
   * @param limit is the limiting end index of heap array till heapifyDown can be performed
   */
	void heapifyDown(int location, int limit);
	
	/**
	 * Heapify Up operation
	 * @param location at which the heapify occurs
	 * @return
	 */
	 ...
	 * @param element foe which index is to be found
	 ...
	 * @param current index at which changeKey is attempted
