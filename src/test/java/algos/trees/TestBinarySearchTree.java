...
public class TestBinarySearchTree {
	...
	public void testHasPathSum() {
		Visitor<Integer, Boolean, Deque<Integer>> v = new HasPathSumVisitor(2400);
	...
	public void testPrintVertical() {
		...
		List<List<Integer>> headToTailList = new ArrayList<List<Integer>>(),
				tailToHeadList = new ArrayList<List<Integer>>();
		...
		Visitor<Integer, Void, List<List<Integer>>> headToTailVisitor = PrintVerticalPathVisitor.of(HEAD_TO_TAIL);
		headToTailVisitor.visit(bst.root());
		assertEquals(headToTailList, headToTailVisitor.collection());

		Visitor<Integer, Void, List<List<Integer>>> tailToHeadVisitor = PrintVerticalPathVisitor.of(TAIL_TO_HEAD);
	...
	public void testMaxSum() {
		...
		Visitor<Integer, Integer, Deque<Integer>> headToTailVisitor = MaxSumPathVisitor.of();
		headToTailVisitor.visit(bst.root());
